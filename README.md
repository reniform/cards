...
At the moment, Blackstar only supports the terminal. No cards are preloaded for the time being. A bonafide release with support for databases would be nice. Then you could actually use it effectively. But that's all in the works. Or I'm daydreaming about it. 

Come back soon though :)

## Requirements
- Just Python 3.x at the moment.
